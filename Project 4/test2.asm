    ...
    addi $7, $6, 0          #0th dmem in R7, 1 operand, 1 distance need stall before going to execute       non-functional needs stall
    addi $8, $6, 0          #0th dmem in R8, 1 operand, 2 distance, get from register bank                  functional
    lw $9, 0($0)            #0th dmem in R9                                                                 test
    sw $9, 8($0)            #0th dmem in 2nd (third) dmem, 1 operand 1 distancein mem                       non functional needs stall
